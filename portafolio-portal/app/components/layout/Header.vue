...
<template>
  ...
  >
    <div class="relative z-50 max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
      ...
      <!-- Desktop Nav -->
      <nav class="hidden md:flex items-center gap-1 bg-black/[0.03] dark:bg-white/[0.03] p-1 rounded-2xl border border-black/[0.05] dark:border-white/[0.05]">
      ...
      <div class="flex items-center gap-3 relative z-10">
        ...
        <!-- Mobile Menu Toggle -->
        <button @click="isMobileMenuOpen = !isMobileMenuOpen" class="md:hidden w-10 h-10 rounded-xl flex items-center justify-center text-slate-900 dark:text-white hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors">
  ...
  <div 
    class="fixed inset-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl z-40 transition-all duration-500 md:hidden flex flex-col items-center justify-center gap-8"
