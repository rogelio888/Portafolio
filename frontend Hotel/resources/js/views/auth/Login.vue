      ...
      <div class="px-8 py-8">
        ...
        <div class="space-y-2">
          <button
            ...
            class="w-full flex items-center gap-3 p-3 bg-purple-50 hover:bg-purple-100 rounded-lg border border-purple-100 hover:border-purple-300 transition-colors cursor-pointer text-left"
          >
          ...
          <button
            type="button"
            @click="fillDemo('gerente', 'gerente123')"
            class="w-full flex items-center gap-3 p-3 bg-indigo-50 hover:bg-indigo-100 rounded-lg border border-indigo-100 hover:border-indigo-300 transition-colors cursor-pointer text-left"
          >
          ...
          <button
            type="button"
            @click="fillDemo('recepcion', 'recepcion123')"
            class="w-full flex items-center gap-3 p-3 bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-100 hover:border-blue-300 transition-colors cursor-pointer text-left"
          >
        ...
        <div class="mt-4 text-center">
          <button
            ...
            @click="handleReset"
            :disabled="resetting"
            class="text-xs font-semibold text-gray-400 hover:text-rose-500 transition-colors disabled:opacity-50"
          >
            {{ resetting ? 'Reiniciando...' : '¿Cuenta bloqueada o datos alterados? Reiniciar demo' }}
          </button>
        </div>
...
const fillDemo = (usuario, password) => {
...
const handleReset = () => {
  ...
  form.value = { usuario: '', password: '' };
  error.value = null;
  setTimeout(() => { resetting.value = false; }, 400);
};
</script>
